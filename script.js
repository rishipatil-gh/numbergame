 ...
 */
function displayHistory(numberGuess) {
  let index; // TODO
  let list = "<ul class='list-group'>";
  // *CODE GOES BELOW HERE *

  document.getElementById("history").innerHTML+='<li>'+"You guessed: "+numberGuess+'</li>';

  /*document.getElementById("history").innerHTML = numberGuess;*/
  list += '</ul>'
...
function getDialog(dialogType, text){
  ...
  switch(dialogType){
    case "warning":
      dialog = "<div class='alert alerts-warning' role='alert'>"
      break;
    case "won":
